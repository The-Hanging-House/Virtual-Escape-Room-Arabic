...
class App extends React.PureComponent {
  ...
  return (
    ...
    <div className="app-text" style={{ display: tryAgain, position: 'absolute', right: '31%', color: 'black', bottom: '20%', fontFamily: 'Dubai W23, sans-serif', zIndex: '5', textAlign: 'center' }}>
      <h3>
