...
import App from '../../../games/lock-ar/App'
            ...
            <Container>
                    ...
                    >
                        ...
                        >
                         ...
                         <button className="close" onClick={() => setShowMessage(false)}><img src={X} alt=" " className="stopDrag" width='300%' height='300%'></img></button>

                            <Alert.Heading>
                            <App />
                            <img src={Lock} alt=" " style={{ left: '-48px', transform: 'scale(0.9)', top: '-33px' }}/>
